...
public class MainzestilleConnector {
    ...
    public void addPatient(ID patientId) {
    ...
    public void readPatient(ID patientId) {
        ...
        readPatientsToken.setResultFields(Arrays.asList("vorname", "nachname", "geburtsname", "geburtstag", "geburtsmonat", "geburtsjahr", "plz", "ort"));
    ...
    public void editPatient(Patient patient, String id) {
        ...
        String editPatientUrl = String.format("patients/tokenId/%s", editPatientTokenId);
        // Validate token
        log.info("ID {}", editPatientUrl);
        // Make request
        MainzellisteResponse editResponse = connection.doRequest(RequestMethod.PUT, editPatientUrl, editDataJson.toString());
